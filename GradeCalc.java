...
public class GradeCalc extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int english, analyticalSkill,GK, totalMarks;
        
       english = Integer.parseInt(jTextField1.getText());
       analyticalSkill = Integer.parseInt(jTextField2.getText());
         GK = Integer.parseInt(jTextField3.getText());
         
         if(english>100 || analyticalSkill>100 || GK>100 ){
        JOptionPane.showMessageDialog(this, "Entered value is not correct");
         }
         
         totalMarks = english+analyticalSkill+GK;
         jTextField4.setText(Integer.toString(totalMarks));
